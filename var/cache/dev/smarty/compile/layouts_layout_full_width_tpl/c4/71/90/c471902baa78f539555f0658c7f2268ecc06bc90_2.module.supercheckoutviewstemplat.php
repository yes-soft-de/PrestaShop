...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5e7fcfb425e866_47762803',
...
function content_5e7fcfb425e866_47762803 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- begin /home/uufoidcqh3m0/public_html/dev.agorachegou.com.br/modules/supercheckout/views/templates/front/shipping_address.tpl -->
<div class="supercheckout-checkout-content"></div>

        <h2><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delivery Address','mod'=>'supercheckout'),$_smarty_tpl ) );?>
 <i class="fas fa-file-invoice"></i></h2>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div id="kb_delivery_update_block" class="actionAddress">
                        <span id="delivery_address_edit" class="kb_edit_btn btn btn-warning" onclick="updateAddressForm('delivery');"><i class="fa fa-edit"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Update Address','mod'=>'supercheckout'),$_smarty_tpl ) );?>
</span>
                        <span id="delivery_address_delete" class="kb_delete_btn btn btn-danger" onclick="deleteAddressForm('delivery');"><i class="fa fa-trash"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Remove Address','mod'=>'supercheckout'),$_smarty_tpl ) );?>
</span>
                    </div>
...
>
                ...
                <?php if ($_smarty_tpl->tpl_vars['settings']->value['shipping_address'][$_smarty_tpl->tpl_vars['p_address_key']->value]['html_format'] == 1) {?>
                    <?php if ($_smarty_tpl->tpl_vars['p_address_key']->value == 'postcode') {?>
                        <div class="row sort_data" id="shipping_post_code" data-percentage="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['shipping_address'][$_smarty_tpl->tpl_vars['p_address_key']->value]['sort_order'], ENT_QUOTES, 'UTF-8');?>
" style="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['display_row']->value, ENT_QUOTES, 'UTF-8');?>
">
                        <?php } else { ?>
                            <div class="row sort_data" data-percentage="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['shipping_address'][$_smarty_tpl->tpl_vars['p_address_key']->value]['sort_order'], ENT_QUOTES, 'UTF-8');?>
" style="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['display_row']->value, ENT_QUOTES, 'UTF-8');?>
">
                            <?php }?>
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    <label class="control-label" for="shipping_address[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_address_key']->value, ENT_QUOTES, 'UTF-8');?>
]"><?php ob_start();
...
]" class="supercheckout-large-field form-control" <?php if ($_smarty_tpl->tpl_vars['p_address_key']->value == 'id_country') {?> onchange="restrictAutofillbyCountry(this)" <?php }?>>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                    ...
                                    <?php } elseif ($_smarty_tpl->tpl_vars['p_address_key']->value == 'other') {?>
                                        <input type="text" name="shipping_address[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['p_address_key']->value, ENT_QUOTES, 'UTF-8');?>
...
'onFocus="geolocate()"<?php }?> name="shipping_address[<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['p_address_key']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['p_address_key']->value == 'address1' || $_smarty_tpl->tpl_vars['p_address_key']->value == 'address2') {?>autocomplete<?php }?>" />
                    ...
                    <?php } else { ?>
                        <?php if ($_smarty_tpl->tpl_vars['p_address_key']->value == 'postcode') {?>
                            <div class="sort_data" id="shipping_post_code" data-percentage="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['shipping_address'][$_smarty_tpl->tpl_vars['p_address_key']->value]['sort_order'], ENT_QUOTES, 'UTF-8');?>
" style="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['display_row']->value, ENT_QUOTES, 'UTF-8');?>
">
                            <?php } else { ?>
                                <div class="sort_data" data-percentage="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value['shipping_address'][$_smarty_tpl->tpl_vars['p_address_key']->value]['sort_order'], ENT_QUOTES, 'UTF-8');?>
" style="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['display_row']->value, ENT_QUOTES, 'UTF-8');?>
">
                                <?php }?>
                                <div class="form-group ">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <!-- end /home/uufoidcqh3m0/public_html/dev.agorachegou.com.br/modules/supercheckout/views/templates/front/shipping_address.tpl --><?php }
}
