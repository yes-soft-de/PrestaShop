                ...
                if (0 === strpos($pathinfo, '/sell/catalog')) {
                    ...
                    elseif (0 === strpos($pathinfo, '/sell/catalog/categories')) {
                        ...
                        if (preg_match('#^/sell/catalog/categories(?:/(?P<categoryId>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_categories_index']), array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::indexAction',  '_legacy_controller' => 'AdminCategories',  '_legacy_link' => 'AdminCategories',  'categoryId' => NULL,));
                            if (!in_array($canonicalMethod, ['GET', 'POST'])) {
                                $allow = array_merge($allow, ['GET', 'POST']);
        ...
        elseif (0 === strpos($pathinfo, '/api')) {
            ...
            if (0 === strpos($pathinfo, '/api/translations')) {
                ...
                if (preg_match('#^/api/translations/(?P<locale>[^/]++)/(?P<domain>[^/]++)(?:/(?P<theme>[^/]++))?$#sD', $pathinfo, $matches)) {
                    $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'api_translation_domain_catalog']), array (  '_controller' => 'prestashop.core.api.translation.controller:listDomainTranslationAction',  'theme' => NULL,  'module' => NULL,));
                    if (!in_array($canonicalMethod, ['GET'])) {
                        $allow = array_merge($allow, ['GET']);
