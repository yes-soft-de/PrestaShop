...
$(function(){
  ...
  const initStripe = async () => {
    ...
    const $submit = $('#velsof_supercheckout_form #placeorderButton #supercheckout_confirm_order_kb, #payment-confirmation button[type="submit"], .stripe-europe-payments[data-method="bancontact"], .ideal-submit-button[data-method="ideal"], .stripe-europe-payments[data-method="giropay"], .stripe-europe-payments[data-method="sofort"], .stripe-submit-button');
    const $submitButtons = $('#velsof_supercheckout_form #placeorderButton #supercheckout_confirm_order_kb, #payment-confirmation button[type="submit"], .stripe-submit-button');
    ...
    */
    $submit.unbind().bind().click(async event => {
//        placeOrder();
//       setTimeout(function(){
