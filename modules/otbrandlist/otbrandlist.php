...
class OtBrandlist extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'otbrandlist';
        ...
        $this->templateFile = 'module:otbrandlist/views/templates/hook/otbrandlist.tpl';
    }
    ...
    public function install()
    {
		...
		Configuration::updateValue('OTBRANDSLIDER', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
			...
			&& Configuration::deleteByName('OTBRANDSLIDER');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitBlockBrands')) {
			...
			$nb_brandslider = (int)Tools::getValue('OTBRANDSLIDER');
    ...
    public function getConfigFieldsValues()
    {
        return array(
			...
			'OTBRANDSLIDER' => Tools::getValue(
                'OTBRANDSLIDER',
                Configuration::get('OTBRANDSLIDER')
            ),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('otbrandlist');
    ...
    public function getWidgetVariables(
        ...
        return array(
			...
			'sliderstatus' => Configuration::get('OTBRANDSLIDER'),
