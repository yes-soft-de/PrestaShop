...
public function install()
{
	...
	/* Adds Module */
		if (parent::install() && $this->registerHook('displayHeader') && $this->registerHook('displayTopHome') && $this->registerHook('displayProductListThumbnails') && $this->registerHook('actionShopDataDuplication'))
		{
			/* Creates tables */
