...
class OtFeaturedProducts extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'otfeaturedproducts';
        ...
        $this->displayName = $this->trans('Ortho Theme Featured products', array(), 'Modules.Featuredproducts.Admin');
        ...
        $this->templateFile = 'module:otfeaturedproducts/views/templates/hook/otfeaturedproducts.tpl';
    }
    ...
    public function install()
    {
        ...
        Configuration::updateValue('HOME_OTFEATURED_NBR', 8);
        Configuration::updateValue('OTFEATUREDSLIDER', 1);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitHomeFeatured')) {
            $nbr = Tools::getValue('HOME_OTFEATURED_NBR');
            ...
            if (isset($errors) && count($errors)) {
                ...
                Configuration::updateValue('HOME_OTFEATURED_NBR', (int) $nbr);
                Configuration::updateValue('OTFEATUREDSLIDER', (int)Tools::getValue('OTFEATUREDSLIDER'));
    ...
    {
        return array(
            'HOME_OTFEATURED_NBR' => Tools::getValue('HOME_OTFEATURED_NBR', (int) Configuration::get('HOME_OTFEATURED_NBR')),
            'OTFEATUREDSLIDER' => Tools::getValue('OTFEATUREDSLIDER', Configuration::get('OTFEATUREDSLIDER')),
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('otfeaturedproducts'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('otfeaturedproducts'));
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return array(
                ...
                'number_of_product' => (int) Configuration::get('HOME_OTFEATURED_NBR'),
                'sliderstatus' => (int) Configuration::get('OTFEATUREDSLIDER'),
            );
        }
        return false;
    }
    ...
    protected function getProducts()
    {
        ...
        $nProducts = Configuration::get('HOME_OTFEATURED_NBR');
        if ($nProducts < 0) {
            $nProducts = 12;
        }
