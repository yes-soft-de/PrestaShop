...
class Wtmegamenu extends Module implements WidgetInterface
{
	...
	public function __construct()
	{
		...
		$this->bootstrap = true;
		parent::__construct();
		$this->displayName = $this->getTranslator()->trans('WT Megamenu', array(), 'Modules.WTMegamenu.Admin');
		$this->description = $this->getTranslator()->trans('Show Megamenus on your site', array(), 'Modules.WTMegamenu.Admin');
