...
class OtSpecials extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'otspecials';
        ...
        $this->displayName = $this->trans('Ortho Theme Specials block', array(), 'Modules.Specials.Admin');
        ...
        $this->templateFile = 'module:otspecials/views/templates/hook/otspecials.tpl';
    }
    ...
    public function install()
    {
        ...
        Configuration::updateValue('BLOCKSPECIALS_OTSPECIALS_NBR', 8);
		Configuration::updateValue('OTSPECIALSLIDER', 1);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitSpecials')) {
            Configuration::updateValue('BLOCKSPECIALS_OTSPECIALS_NBR', (int)Tools::getValue('BLOCKSPECIALS_OTSPECIALS_NBR'));
            Configuration::updateValue('OTSPECIALSLIDER', (int)Tools::getValue('OTSPECIALSLIDER'));
            $this->_clearCache('*');
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'BLOCKSPECIALS_OTSPECIALS_NBR',
    ...
    {
        return array(
            'BLOCKSPECIALS_OTSPECIALS_NBR' => Tools::getValue('BLOCKSPECIALS_OTSPECIALS_NBR', Configuration::get('BLOCKSPECIALS_OTSPECIALS_NBR')),
            'OTSPECIALSLIDER' => Tools::getValue('OTSPECIALSLIDER', Configuration::get('OTSPECIALSLIDER')),
        );
    }

    public function renderWidget($hookName = null, array $configuration = [])
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('otspecials'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('otspecials'));
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return array(
                ...
                'number_of_product' => (int) Configuration::get('BLOCKSPECIALS_OTSPECIALS_NBR'),
                'sliderstatus' => (int) Configuration::get('OTSPECIALSLIDER'),
            );
        }
        return false;
    }
    ...
    private function getSpecialProducts()
    {
        $products = Product::getPricesDrop(
            ...
            0,
            (int)Configuration::get('BLOCKSPECIALS_OTSPECIALS_NBR')
        );
