...
{assign var='height' value = $slier_option_arr.height|cat:'px'}
	...
	<script type="text/javascript" src="{$wtslideshow_path|escape:'html':'UTF-8'}views/js/jquery-1.7.1.min.js"></script>
	<script type="text/javascript" src="{$wtslideshow_path|escape:'html':'UTF-8'}views/js/layerslider.kreaturamedia.jquery.js"></script>
	<script type="text/javascript" src="{$wtslideshow_path|escape:'html':'UTF-8'}views/js/layerslider.transitions.js"></script>
