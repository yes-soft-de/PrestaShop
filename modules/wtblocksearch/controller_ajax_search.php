...
else
{
	...
	$wtlivesearch = new WtBlockSearch();
	$searchResults = $wtlivesearch->LiveSearchProduct($id_cat, Context::getContext()->language->id, $search_string);
...
else
{
	...
	echo $wtlivesearch->display(dirname(__FILE__).'/wtblocksearch.php', 'wt_search_result.tpl');
