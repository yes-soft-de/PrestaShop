...
class WtBlockSearch extends Module implements WidgetInterface
{
	private $html;
	public function __construct()
	{
		...
		$this->displayName = $this->getTranslator()->trans('WT Ajax Live Category Search', array(), 'Modules.WTBockSearch.Admin');
		$this->description = $this->getTranslator()->trans('Show a quick search category to your website..', array(), 'Modules.WTbBockSearch.Admin');
	...
	public function install()
	{
		...
		if (!parent::install() || !$this->registerHook('displayTop') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap'))
			return false;
		return true;
	}
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addJS($this->_path.'views/js/wtblocksearch.js');
...
{
		return array(
			'num_item_display' => Tools::getValue('num_item_display', Configuration::get('NUM_ITEM_DISPLAY'))
		);
}
	...
	{
		return $this->display(__FILE__, 'wtblocksearch-nav.tpl');
	}
...
public function _displayAdvertising()
{
	...
	public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        return $this->fetch('module:'.$this->name.'/views/templates/hook/wtblocksearch-top.tpl');
    }
	...
	public function LiveSearchProduct($id_cat, $id_lang, $expr, $page_number = 1, $page_size = 1, $order_by = 'position',
        $order_way = 'asc', $ajax = false, $use_cookie = true, Context $context = null)
	{
		if ($id_cat == 'all')
			$id_cat = 0;
