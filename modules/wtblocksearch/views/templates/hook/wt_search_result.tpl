...
<div class="search-title">
	{l s='The result search for ' d='Modules.WTBockSearch'} "{$query|escape:'quotes':'UTF-8'}" <span>({$search_Total|escape:'quotes':'UTF-8'} {l s=' results have been found.' mod='wtblocksearch'})</span>
...
{$num = 0}
	...
	{else}
	<p class="noresult">{l s='No found any item!' d='Modules.WTBockSearch'}</p>
{/if}
</ul>
{if $search_Total > $limit_item}
<p class="title_showall_text">{l s='Search limited to ' d='Modules.WTBockSearch'} {$limit_item|escape:'quotes':'UTF-8'} {l s='products' mod='wtblocksearch'}</p>
<p class="title_showall">
<a href="#" onclick="Show_All_Search();return false;">
	<span>{l s='show alls' d='Modules.WTBockSearch'}</span>
	</a>
</p>
{/if}
</div>
