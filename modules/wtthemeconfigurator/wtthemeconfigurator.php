...
class WtThemeConfigurator extends Module
{
	...
	public function hookdisplayHeader()
	{
		...
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery-1.7.1.min.js');
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.scrollTo.js');
		$this->context->controller->addJs($this->_path.'views/js/frontend/jquery.serialScroll.js');
