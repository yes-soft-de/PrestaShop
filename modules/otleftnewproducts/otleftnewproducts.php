...
class OtLeftnewProducts extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'otleftnewproducts';
        ...
        $this->displayName = $this->trans('Ortho Theme New products Leftside block', array(), 'Modules.Newproducts.Admin');
        $this->description = $this->trans('Displays a block featuring your store\'s newest products.', array(), 'Modules.Newproducts.Admin');

        $this->templateFile = 'module:otleftnewproducts/views/templates/hook/otleftnewproducts.tpl';
    }
    ...
    public function install()
    {
		...
		Configuration::updateValue('NEW_OTPRODUCTS_NBR', 3);
		Configuration::updateValue('OTNEWSLIDER', 0);
    ...
    public function uninstall()
    {
        ...
        if (!parent::uninstall() ||
            !Configuration::deleteByName('NEW_OTPRODUCTS_NBR')) {
            return false;
        }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitBlockNewProducts')) {
            ...
            $productNbr = Tools::getValue('NEW_OTPRODUCTS_NBR');
            ...
            if (!$productNbr || empty($productNbr)) {
                ...
                Configuration::updateValue('OTNEWSLIDER', (int)Tools::getValue('OTNEWSLIDER'));
                Configuration::updateValue('NEW_OTPRODUCTS_NBR', (int)$productNbr);
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'NEW_OTPRODUCTS_NBR' => Tools::getValue('NEW_OTPRODUCTS_NBR', Configuration::get('NEW_OTPRODUCTS_NBR')),
            'OTNEWSLIDER' => Tools::getValue('OTNEWSLIDER', Configuration::get('OTNEWSLIDER')),
        );
    }

    public function renderWidget($hookName, array $configuration)
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('otleftnewproducts'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('otleftnewproducts'));
    }
    ...
    public function getWidgetVariables($hookName, array $configuration)
    {
        ...
        if (!empty($products)) {
            return array(
                ...
                'number_of_product' => (int) Configuration::get('NEW_OTPRODUCTS_NBR'),
                'sliderstatus' => (int) Configuration::get('OTNEWSLIDER'),
            );
        }
        return false;
    }
    ...
    protected function getNewProducts()
    {
        ...
        if (Configuration::get('PS_NB_DAYS_NEW_PRODUCT')) {
            $newProducts = Product::getNewProducts(
                ...
                0,
                (int)Configuration::get('NEW_OTPRODUCTS_NBR')
            );
        }
